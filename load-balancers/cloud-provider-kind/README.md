...
[`cloud-provider-kind`](https://github.com/kubernetes-sigs/cloud-provider-kind) aims to fill this gap and provide an agnostic and cheap solution for all the Kubernetes features that depend on a cloud-provider using KIND.
